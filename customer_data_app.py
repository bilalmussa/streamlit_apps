...
with row1_1:
    st.markdown("Hello, this is Bilal, and welcome to my Quick Analysis app. We just need 4 columns from your transactional data, and the app will automaically profile your customers and will display various statistics and charts for your analysis.")
